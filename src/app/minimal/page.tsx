  ...
  return (
    ...
    <div className="flex flex-col">
      ...
      <div className="bg-zinc-50 flex justify-between items-center px-6 py-6 sticky top-0">
        ...
        <button className="text-lg py-3 px-6 text-zinc-100 rounded-xl font-bold transition-all bg-gradient-to-t from-zinc-700 to-zinc-900 hover:from-zinc-950 hover:to-zinc-950 shadow-[0_10px_15px_rgba(0,0,0,0.04),0_2px_4px_rgba(0,0,0,0.15)]">
          Buy now
        </button>
      </div>
      ...
      <div className="bg-zinc-950 h-[90vh] flex justify-center py-6">
        <div className="mx-24 w-full h-full flex flex-col items-center">
          <div className="flex w-full">
            <div className="flex flex-1 flex-col text-zinc-50 gap-6">
              ...
              <button className="text-lg py-3 px-6 bg-none rounded-xl border-2 border-zinc-50 text-zinc-200 font-bold hover:bg-zinc-800 hover:text-zinc-100 transition-all cursor-pointer">
                Lets connect
              </button>
            </div>
          ...
          <h1 className="font-satoshi text-zinc-50 text-9xl font-bold text-[20em]">
            balance.
          </h1>
        </div>
      </div>
